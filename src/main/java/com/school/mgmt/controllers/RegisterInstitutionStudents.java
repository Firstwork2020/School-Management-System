...
public class RegisterInstitutionStudents {
	 ...
	 */
	@PostMapping(path = "/school/students/register", consumes = "application/json")
	public ResponseEntity<String> schoolLogin(@RequestBody UserAuthenticationRequest userRequest) throws SchoolMgmtGenericException {
		...
		return new ResponseEntity<String>("Hey student - you are registered with the institute", HttpStatus.OK);
	}
